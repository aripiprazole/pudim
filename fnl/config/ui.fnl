...
(telescope.setup {:defaults {:file_ignore_patterns [:node_modules
                  ...
                  :extensions {:media_files {:filetypes [:png
                                                         :jpeg
                                                         :jpg
                                                         :mp4
                                                         :webm
...
(vim.api.nvim_set_keymap :n :<leader>ltt :<cmd>Trouble<CR> {:noremap true})

;; Open diagnostic menu
(vim.api.nvim_set_keymap :n :<leader>ltd :<cmd>TroubleToggle<CR>
                         {:noremap true})

;; Open TODO menu
(vim.api.nvim_set_keymap :n :<leader>so :<cmd>SymbolsOutline<CR>
                         {:noremap true})
...
;; Open find files
(vim.api.nvim_set_keymap :n :<leader>fd "<cmd>Telescope dap commands<CR>"
                         {:noremap true})

;; Open dap commands
(vim.api.nvim_set_keymap :n :<leader>fdb
                         "<cmd>Telescope dap list_breakpoints<CR>"
                         {:noremap true})

;; Open dap breakpoints
(vim.api.nvim_set_keymap :n :<leader>fdf "<cmd>Telescope dap frames<CR>"
                         {:noremap true})

;; Open dap frames
(vim.api.nvim_set_keymap :n :<leader>fdv "<cmd>Telescope dap variables<CR>"
                         {:noremap true})
...
;; Open colorscheme change
(vim.api.nvim_set_keymap :n :<leader>fgit "<cmd>Telescope git_commits<CR>"
                         {:noremap true})

;; Open telescope commits
(vim.api.nvim_set_keymap :n :<C-P> "<cmd>Telescope commands<CR>"
                         {:noremap true})

;; Open telescope commands
