...
;; Make backspace delete to the left
...
;; Setup Comment
(Comment.setup {:toggler {:line :gcc :block :gcb}})

(indent-blankline.setup {:space_char_blankline " " :show_end_of_line true})
